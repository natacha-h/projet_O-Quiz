...
?>
            ...
            <div class="row">
                    ...
                    <section class="form-group col-md" >
                        ...
                        <input type="firstname" class="form-control" id="firstname" name="firstname"aria-describedby="firstnameHelp" placeholder="Prénom" >
                
                    </section>

                    <section class="form-group col-md">
                        <label for="lastname">Votre nom</label>
                        <input type="lastname" class="form-control" id="lastname" name="lastname" aria-describedby="lastnameHelp" placeholder="Nom" >
                ...
                <div class="row">
                    ...
                    <section class="form-group col-md">
                        ...
                        <input type="email" class="form-control" id="email" name="email" aria-describedby="emailHelp" placeholder="exemple@e-mail.com" >
